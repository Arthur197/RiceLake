...
<body>
    <!--////////////////////////////Nav Bar////////////////////////////////-->
    <div class="topnav">
        <h1><a href="index.php">Arrowhead Camp</a></h1>
        ...
        <a class="link active" href="login.php" style="float:right;">User Login</a>
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>To reset a forgotten password, please email arrowheadcampresort@gmail.com with your username</p>
        </form>
    </div>   
